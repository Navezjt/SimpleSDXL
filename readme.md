...
## 🔔 更新 / Update
- [2023.11.26] 新增顶部工具条，实现了场景预置包的切换和背景切换。优化界面布局，将“出图数量”选项提高到首屏，默认中文界面、夜黑背景和高级选项打开。总之常用操作尽可能快捷。这是一次重要的升级，基于定制预置包，可以简化步骤，快速进入特定使用场景。欢迎定制自己的专属预置包！同步主线最新版本v2.1.824。
